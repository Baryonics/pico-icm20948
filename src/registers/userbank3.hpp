...
namespace icm20948::registers
{
    ...
    {
        static constexpr BitField<0, 3> ODR_CONFIG{};
    };

    struct I2C_MST_CTRL : RegBase<addresses::I2C_MST_CTRL, UserBank::UB3, AccessT::rw>
    {
        static constexpr Bit<7> MULT_MST_EN{};
        static constexpr Bit<4> I2C_MST_P_NSR{};
        static constexpr BitField<0, 3> I2C_MST_CLK{};
    };

    struct I2C_MST_DELAY_CTRL : RegBase<addresses::I2C_MST_DELAY_CTRL, UserBank::UB3, AccessT::rw>
    {
        static constexpr Bit<7> DELAY_ES_SHADOW{};
        static constexpr Bit<4> I2C_SLV4_DELAY_EN{};
        static constexpr Bit<3> I2C_SLV3_DELAY_EN{};
        static constexpr Bit<2> I2C_SLV2_DELAY_EN{};
        static constexpr Bit<1> I2C_SLV1_DELAY_EN{};
        static constexpr Bit<0> I2C_SLV0_DELAY_EN{};
    };

    struct I2C_SLV0_ADDR : RegBase<addresses::I2C_SLV0_ADDR, UserBank::UB3, AccessT::rw>
    {
        static constexpr Bit<7> I2C_SLV0_RNW{};
        static constexpr BitField<0, 6> I2C_ID_0{};
    };

    struct I2C_SLV0_REG : RegBase<addresses::I2C_SLV0_REG, UserBank::UB3, AccessT::rw>
    {
        static constexpr BitField<0, 7> REG{};
    };

    struct I2C_SLV0_CTRL : RegBase<addresses::I2C_SLV0_CTRL, UserBank::UB3, AccessT::rw>
    {
        static constexpr Bit<7> I2C_SLV0_EN{};
        static constexpr Bit<6> I2C_SLV0_BYTE_SW{};
        static constexpr Bit<5> I2C_SLV0_REG_DIS{};
        static constexpr Bit<4> I2C_SLV0_GRP{};
        static constexpr BitField<0, 3> I2C_SLV0_LENG{};
    };

    struct I2C_SLV0_DO : RegBase<addresses::I2C_SLV0_DO, UserBank::UB3, AccessT::rw>
    {
        static constexpr BitField<0, 7> DO{};
    };

    struct I2C_SLV1_ADDR : RegBase<addresses::I2C_SLV1_ADDR, UserBank::UB3, AccessT::rw>
    {
        static constexpr Bit<7> I2C_SLV1_RNW{};
        static constexpr BitField<0, 6> I2C_ID_1{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV1_EN{};
        static constexpr Bit<6> I2C_SLV1_BYTE_SW{};
        static constexpr Bit<5> I2C_SLV1_REG_DIS{};
        static constexpr Bit<4> I2C_SLV1_GRP{};
        static constexpr BitField<0, 3> I2C_SLV1_LENG{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV2_RNW{};
        static constexpr BitField<0, 6> I2C_ID_2{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV2_EN{};
        static constexpr Bit<6> I2C_SLV2_BYTE_SW{};
        static constexpr Bit<5> I2C_SLV2_REG_DIS{};
        static constexpr Bit<4> I2C_SLV2_GRP{};
        static constexpr BitField<0, 3> I2C_SLV2_LENG{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV3_RNW{};
        static constexpr BitField<0, 6> I2C_ID_3{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV3_EN{};
        static constexpr Bit<6> I2C_SLV3_BYTE_SW{};
        static constexpr Bit<5> I2C_SLV3_REG_DIS{};
        static constexpr Bit<4> I2C_SLV3_GRP{};
        static constexpr BitField<0, 3> I2C_SLV3_LENG{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV4_RNW{};
        static constexpr BitField<0, 6> I2C_ID_4{};
    };
    ...
    {
        static constexpr Bit<7> I2C_SLV4_EN{};
        static constexpr Bit<6> I2C_SLV4_BYTE_SW{};
        static constexpr Bit<5> I2C_SLV4_REG_DIS{};
        static constexpr Bit<4> I2C_SLV4_GRP{};
        static constexpr BitField<0, 3> I2C_SLV4_LENG{};
    };
    ...
    {
        static constexpr BitField<0, 7> DI{};
    };
} // namespace icm20948::registers
